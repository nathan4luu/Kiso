  ...
  if (!loading) {
    const decks = [
      ...
      },
      {
        ...
        title: "Seventh",
        description:
          "This flashcard set covers fundamental concepts and topics in discrete mathematics, essential for computer science and mathematical reasoning. This flashcard set covers fundamental concepts and topics in discrete mathematics, essential for computer science and mathematical reasoning.",
        termCount: 10,
        user: "Nathan Luu",
        userId: 2,
        profilePhoto:
